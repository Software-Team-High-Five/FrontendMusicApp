<template>
    <div>
            ...
            <div class="card">
                <table class="table"  style="margin-bottom: 0px;">
                    <thead style="background-color: #f2f3f4;">
                        <tr><th colspan="4" style="border-bottom: none;"><h4>Upcoming Events</h4></th></tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr v-show="!upcomingEvents.length"><td><strong>No Upcoming Events</strong></td></tr>
                    </tbody>
                </table>
        ...
        <br>
        <div class="col-md-15" style="border-radius: 5px; padding: 10px; margin: 10px;" v-show="!isUpcoming">
            <div class="card">
                <table class="table" style="margin-bottom: 0px;">
                    <thead style="background-color: #f2f3f4;">
                        <tr><th colspan="4" style="border-bottom: none;"><h4>Registered Events</h4></th></tr>
                        <tr>
                            <th scope="col">Name</th>
                            <th scope="col">Type</th>
                            <th scope="col">Date</th>
                    ...
                    <tbody>
                        ...
                        <tr v-show="!registeredEvents.length"><td><strong>No Registered Events</strong></td></tr>
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <div class="col-md-15" style="border-radius: 5px; padding: 10px; margin: 10px;" v-show="!isUpcoming">
            <div class="card">
                <table class="table" style="margin-bottom: 0px;">
                    <thead style="background-color: #f2f3f4;">
                        <tr><th colspan="4" style="border-bottom: none;"><h4>My Past Events</h4></th></tr>
                        <tr>
                            <th scope="col">Name</th>
                            <th scope="col">Type</th>
                            <th scope="col">Date</th>
                    ...
                    <tbody>
                        ...
                        <tr v-show="!myPastEvents.length"><td><strong>No Past Events</strong></td></tr>
        ...
        <Modal title="Filters" v-model="showFilters">
            ...
            <MultiSelect
                ...
                <template 
                    slot="selection" 
                    slot-scope="{ eventTypes,  isOpen }"
                ><span class="multiselect__single" v-if="eventTypes" v-show="!isOpen">{{ activeTypes }}</span></template>
            </MultiSelect>
            <br><br>
            <v-row>
                <v-col>
